...
*This is the full technical deep dive with schema examples, security model, and scope boundary analysis. For the accessible version with the core argument and mental models, start with [MCP Walked So We Could Run →](/posts/mcp-walked-so-we-could-run).*
